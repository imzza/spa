const employees = {
    ...
    verify_code(code, cb, errorCb) {
        axios
            .post(API_URL + '/employee_verify', { code: code })
            .then(resp => {
                if (resp.status == 200) {
                    cb(resp.data);
                } else {
    ...
    create_profile(data, cb, errorCb) {
        axios
            .post(API_URL + '/create_profile', data)
            .then(resp => {
                if (resp.status == 201) {
                    cb(resp.data);
                } else {
