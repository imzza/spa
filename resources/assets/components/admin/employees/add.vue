                ...
                <form @submit.prevent="onSubmit">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input id="" type="file" v-validate="'required|mimes:image/*'" class="custom-file-input form-control form-control-lg" name="image" data-vv-name="image" data-vv-as="image" :class="{ 'is-invalid': errors.has('image') }" @change="readFile($event)" />
