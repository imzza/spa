                                    ...
                                    <div class="custom-actions">
                                        <button class="btn btn-default btn-sm"
                                         ...
                                         <button class="btn btn-info btn-sm"
                                                @click="onAction('assign-roles', props.rowData, props.rowIndex)">
                                                Roles
                                        </button>
            ...
            <form @submit.prevent="assignRole">
                <div class="form-group">
                    ...
                    <div v-for="role in roles" :key="role.id">
                        <li><input type="checkbox" v-model="emp_roles" :value="role.name" :true-value="role.name" :id="role.id"><label :for="role.id">{{ role.name }}</label></li>
                    </div>
                   <!-- <multiselect
                      v-model="emp_roles"
                      :options="roles"
  ...
  methods: {
    ...
    deleteEmp(emp){
        ...
        Notify.confirm().then(r => {
            employees.delete(emp.weeid, data =>{
