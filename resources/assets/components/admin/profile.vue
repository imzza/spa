<template>
	...
	<div class="row">
      ...
      <div class="col-md-9  personal-info">
        ...
        <form class="form-horizontal" role="form" @submit.prevent="updateUser">
          <div class="col-md-3">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" name="name" id="name" v-model="model.name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">First name:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" v-model="model.first_name">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Last name:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" name="last_name" id="last_name" v-model="model.last_name">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-lg-8">
              ...
              <input class="form-control" type="text" name="email" id="email" v-model="model.email">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Phone No:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" name="phone_no" id="phone_no" v-model="model.phone_no">
            </div>
          </div>
          <div class="form-group">
            <label class="col-lg-3 control-label">Current Password:</label>
            <div class="col-lg-8">
              <input class="form-control" type="password" name="current_password" id="current_password" v-model="model.current_password">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="password" name="password_confirmation" id="password_confirmation" v-model="model.password_confirmation">
