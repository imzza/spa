...
Route::get('test', function () {
    $js = \App\Http\Controllers\EmployeesController::sendAccountCreationEmail(
        'irfanullah@techleadz.com',
        'John'
    );
    return $js;
});
...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::group(["prefix" => 'v1'], function () {
        ...
        Route::get(
            'permission_by_group',
            'PermissionsController@permission_by_group'
        );
        Route::post(
            'roles_assign_permissions',
            'RolesController@roles_assign_permissions'
        );
        Route::get(
            'permission_by_role/{role}',
            'PermissionsController@permission_by_role'
        );
