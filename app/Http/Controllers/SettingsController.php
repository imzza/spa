...
class SettingsController extends Controller
{
    ...
    public  function get_locations(){
        ...
        if ($branches !== '') {
    		return response()->json(['error'=>false,'locations'=> $branches, 'total_locations'=>$total_locations]);
    	}
    }
    ...
    public  function get_location_data(Request $request,$location_id){
        ...
        if ($Location !='' && $LocationTimes!='') {
    		return response()->json(['error'=>false,'location'=> $Location,'locationtimes'=> $LocationTimes, 'total_bookings'=> $total_bookings, 'DaysClose'=> $DaysClose, 'Days'=>$Days, 'holidays'=>$SpecialDays]);
    	}else {
    		return response()->json(['error'=>true,'message'=>'Something went wrong'], $this->unprocessableStatus);
    	}
    }
    ...
    public function get_language(Request $request){
        ...
        return response()->json(['error' => false, 'message' => 'Un authenticated']);
    ...
    public  function delete_location(Request $request,$location_id){
        ...
        if($total_locations > 1){
            ...
            return response()->json(['error'=>true,'message'=>'Can not delete last location']);
        }
    }
